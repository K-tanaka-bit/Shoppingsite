...
<li><a href="../views/shopping.jsp">すべて</a></li>
...
<input type="number" min="0" name="minPrice"class="price">~<input type="number" min="0" name="maxPrice"class="price">
<input type="submit" value="OK"class="button">
</form></li></ul></div>
<div class="item">
		<%
		List<ShoppingBean> categoryList = (List<ShoppingBean>) session.getAttribute("categoryList");
		for (ShoppingBean list : categoryList) {
		%><ul class="product">
		<li><span>
